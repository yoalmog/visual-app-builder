...
import { findNode, findParent, isDescendant } from '../src/builder/tree/find-node.js';
import { insertNode } from '../src/builder/tree/insert-node.js';
import { removeNode } from '../src/builder/tree/remove-node.js';
import { updateNode } from '../src/builder/tree/update-node.js';
import { moveNode } from '../src/builder/tree/move-node.js';
import { duplicateNode, cloneNodeWithNewIds } from '../src/builder/tree/duplicate-node.js';
import { pushHistory, undoHistory, redoHistory } from '../src/builder/history/history-manager.js';
import { COMPONENT_REGISTRY, createDefaultNode } from '../src/builder/components/registry.js';
import { INSPECTOR_DEFINITIONS } from '../src/builder/components/definitions.js';
import { AppProjectSchema } from '../src/builder/schema/validation.js';
...
const newNode = { id: 'btn_2', type: 'button', name: 'Btn 2', props: {}, styles: {}, children: [] };
...
console.log('\n--- 7. Tree Utilities: moveNode & Cycle Prevention ---');
// Create a fresh tree to test moveNode
const moveTestTree = {
  id: 'root',
  type: 'container',
  name: 'Root',
...
// 8. History: Undo / Redo
console.log('\n--- 8. History: Undo / Redo ---');
const mockProject1 = { id: 'p1', name: 'P1', version: 1, theme: { primaryColor: '#000', backgroundColor: '#fff', textColor: '#000', borderRadius: '4px' }, assets: [], pages: [] };
const mockProject2 = { ...mockProject1, name: 'P2' };
const mockProject3 = { ...mockProject1, name: 'P3' };
